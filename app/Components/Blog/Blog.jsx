...
const Blog = () => {
  return (
    <div className="max-w-[1280px] mx-auto my-[112px]">
      <p className="text-base text-[#1C1C57] pb-4 text-center font-normal">
        Inspiration
      </p>
      <h3 className="text-[40px] font-semibold text-[#1C1C57] leading-[120%] text-center">
        Discover the Design World
      </h3>
      <p className="text-base font-normal text-[#1C1C57] text-center mt-6">
